// Lab build of the hero interactions: the four portals are plain icons that
// drift inside the hero's safe zone, pause under the cursor, click through to
// their section, and converge downward when the page scrolls.
// Shared behaviours (cursor, reveal, phone feed, eye-follow, click sound) are
// carried over from script.js so this page stands alone.
...
// eyes on the right portrait follow the cursor (same as main build)
...
// Drag the blossom layer behind the left portrait (same as main build)
